...
\begin{frame}{DEQIP Example}
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.9\textwidth]{deq/deqip_example}
        \caption{A deconvolution example from \citep{gilton2021deep}.}
    \end{figure}
\end{frame}
...
\begin{frame}{Summary of this Week}
    ...
    \begin{enumerate}
        \item \textbf{Basics:} An introduction to deep learning.
